// FILE: app/(public)/components/home/LatestPosts.tsx
        ...
        <div key={index}>
          ...
          <div>
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-5">
              {category?.blogs?.map((blog: any, index: number) => (
                <div
                  key={index}
